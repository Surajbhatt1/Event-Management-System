...
<html lang="en">
<head>
<title>Event Management System | Mail</title>
	...
	<div class="contact">
		<div class="container">
			<div class="agile-contact-form">
				...
				<img src="images/register-now.jpg" alt="" height="500" width="500">
					</div>
				</div>
				<div class="col-md-6 contact-form-right">
					...
					<div class="agileinfo-contact-form-grid">
						<form method="post" name="signup" onsubmit="return checkpass();">
                                                <input type="text" name="fname" placeholder="Full Name" maxlength="10" pattern="[A-Za-z]+"required="true">
